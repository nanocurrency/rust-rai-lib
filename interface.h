...
// Calculates the hash of transaction and returns it as a malloc'd hex-encoded null-terminated string
char * xrb_hash_transaction (const char * transaction);

// Generates work for a given root
uint64_t xrb_work (xrb_uint256 root);
